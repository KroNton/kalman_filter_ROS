...
def movement_callback(movement_data):
    ...
    belief = predict_step(belief, movement_data.data, kernel)
...
def sensor_callback(sensor_data):
    ...
    likelihood_estimation = likelihood(corridor_map, z=sensor_data.data, z_prob=light_sensor_accuracy_rate)
